...
# ==============================
file_path = r"simulated_series_V7_I18.3_F45_T100.xlsx"   # <-- change if needed
df = pd.read_excel(file_path)

# Expect columns: Time, Length, Height (or Height%)
if "Height%" in df.columns:
    df["Height"] = (df["Height%"] / 100.0) * 5.0   # scale % → mm
...
x = df["Time"].to_numpy()   # use Time instead of Length
...
for i in range(len(x_smooth) - 1):
    ...
    verts.append([v1, v2, v3, v4])       # top
    verts.append([v1b, v2b, v3b, v4b])   # bottom
    verts.append([v1, v4, v4b, v1b])     # side 1
    verts.append([v2, v3, v3b, v2b])     # side 2
    verts.append([v1, v2, v2b, v1b])     # side 3
    verts.append([v4, v3, v3b, v4b])     # side 4
